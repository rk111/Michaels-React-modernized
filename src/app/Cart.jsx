...
export default function Cart({ items, setItems, onShop, mini = false, onViewCart }) {
  ...
  return <section className={`cart-content${mini ? ' mini-cart-content' : ''}`} data-figma-section={mini ? '2:10' : '02'}>
    ...
    {!mini && checkout !== 'confirmation' && checkout !== 'receipt' && <p className="muted">{checkout ? (checkout === 'review' ? '1 Shipping ✓ / 2 Payment ✓ / 3 Review' : '1 Shipping ✓ / 2 Payment / 3 Review') : 'Keep creating with supplies delivered on your schedule.'}</p>}
